...
import com.tengda.databindingframe.R;
import com.tengda.databindingframe.widgets.util.Logger;
...
public abstract class BaseLayout extends LinearLayout
    ...
    private void init(final Context context, AttributeSet attrs,int defStyleAttr){
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.TDRecyclerView);
        duration = array.getInteger(R.styleable.TDRecyclerView_duration,200);

        setBackgroundColor(array.getColor(R.styleable.TDRecyclerView_layout_color,backgroundColor));
        isPullRefreshEnable = array.getBoolean(R.styleable.TDRecyclerView_pull_eable,true);
        isPullLoadEnable = array.getBoolean(R.styleable.TDRecyclerView_push_able,true);
        overResistance = array.getFloat(R.styleable.TDRecyclerView_over_resistance,0.4f);
        resistance = array.getFloat(R.styleable.TDRecyclerView_push_resistance,0.6f);
        overScroll = array.getBoolean(R.styleable.TDRecyclerView_over_scroll,true);
        innerView = array.getString(R.styleable.TDRecyclerView_inner_view);
        LoadDataScrollEnable = array.getBoolean(R.styleable.TDRecyclerView_loaddata_scrolleable,false);
        int interpolatorId = array.getResourceId(R.styleable.TDRecyclerView_interpolator, android.R.anim.accelerate_decelerate_interpolator);
        ...
        contentView.setBackgroundColor(array.getColor(R.styleable.TDRecyclerView_contentview_color,contentViewColor));
        array.recycle();
    }
