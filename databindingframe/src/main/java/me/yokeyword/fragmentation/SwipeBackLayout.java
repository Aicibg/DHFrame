...
import com.tengda.databindingframe.base.BaseSwipeBackCompatActivity;
import com.tengda.databindingframe.base.BaseSwipeBackCompatFragment;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    public void setEdgeOrientation(int orientation) {
        ...
        if (orientation == EDGE_RIGHT || orientation == EDGE_ALL) {
            setShadow(R.drawable.shadow_left, EDGE_RIGHT);
        }
    }
